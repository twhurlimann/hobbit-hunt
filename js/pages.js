  ...
  bridge3: {
    ...
    stone1: {
        ...
        story:
            ...
            "Return my ring" you hear a soft, almost airy voice demand behin you
            You turn around to see the pale, terrifying face of a female spectre who suddenly opens her mouth wide, screams deafeningly loud and flys into you, disappearing along with the mist
            Didn't Tyler give you this ring? You should demand an explination from him
            `,

        prompt:
            "See Tyler for the answer to move on",
        ...
        failure:
            "Make sure you speak with Tyler",
    ...
    stone2: {
        ...
        story:
            `
           You're preparing to journey to Rivendell in hopes of learning more about this ring and hopefully quiting the ghost that haunts it
        ...
        prompt:
            "Waters near Rivendell? It must be that river which runs into it, what was its name again?",
        ...
        failure:
            "Check the map, you should see a river named to the South of Rivendell",
    ...
    stone3: {
        ...
        prompt:
            "Someone has a ring which can control water, enter where the ring came from",
        ...
        failure:
            "What is the original place from which the water ring came from?",
